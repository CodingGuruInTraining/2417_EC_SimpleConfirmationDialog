...
public class ShowSimpleDialogActivity extends AppCompatActivity implements SimpleDialogFragment.SimpleDialogFragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.show(getSupportFragmentManager(), "Simple Dialog");
            }
        });
    }
